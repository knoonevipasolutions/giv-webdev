//VIPA sbenes - including actual for https://github.com/select2/select2/issues/2552
...
define('select2/dropdown/attachBody',[
  ...
  AttachBody.prototype.position = function (decorated, $dropdown, $container) {
    ...
    //fix VIPA -sbenes https://github.com/select2/select2/issues/2552
    $dropdown.width($container.actual('outerWidth'));
...
define('select2/core',[
  ...
  Select2.prototype._resolveWidth = function ($element, method) {
    ...
    if (method == 'element') {
        //fix VIPA -sbenes https://github.com/select2/select2/issues/2552
      var elementWidth = $element.actual('outerWidth');
